 ...
 */
const SPICY = {
  // The Far Beach brief below covers both sexes. There is deliberately no
  // entry for the changing-cabin occupant: that gag is a hard cut with no
  // sprite on screen at all, so char.cabin is generated by nothing and a
  // brief for it would be config that looks live and never runs.
  'char.guest': [
